...
#ifndef P_tmpdir
#define P_tmpdir "/data/data/com.itsaky.androidide/files/framework/tmp"
#endif
...
GetJavaProperties(JNIEnv *env)
{
    ...
    if(sprops.tmp_dir == NULL) {
        sprops.tmp_dir = "/data/data/com.itsaky.androidide/files/framework/tmp";
    }
#ifdef MACOSX
    ...
    /* user properties */
    {
        ...
        sprops.user_name = pwent ? strdup(pwent->pw_name) : "itsaky";
#ifdef MACOSX
        setUserHome(&sprops);
#else
        ...
        if (sprops.user_home == NULL) {
            sprops.user_home = "/data/data/com.itsaky.androidide/files/framework";
        }
    }
